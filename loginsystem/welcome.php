...
{?>                        
                        <div class="row" >
                            ...
                            <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Here is your Work <?php echo $result['fname'].$result['lname'];?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="displayProduct.php">Handle Jobs</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
